...
require_once 'thumbnail.php';
    ...
    if($_POST) {
       ...
       // if(filter_input(INPUT_POST, "id", FILTER_SANITIZE_NUMBER_INT)) {
        ...
        if (atualizarProduto($id, $cod, $prod, $quant, $price, $desc, $rev, $alt, $larg, $comp, $diam, $peso, $marca, $cat, $foto)){
      ...
      header("location:atualizar_prod.php?prodid=$id");
    }
    ?>